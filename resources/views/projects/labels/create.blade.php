...
@section('title', 'Create Label - ' . $project->name)
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Create Label - {{ $project->name }}</h5>
                </div>
                    ...
                    <form method="POST" action="{{ route('projects.labels.store', $project) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('color') is-invalid @enderror" id="colorHex" value="{{ old('color', '#6c757d') }}" readonly>
                            </div>
                            @error('color')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <span class="badge" id="labelPreview" style="background-color: {{ old('color', '#6c757d') }}">
                                    {{ old('name') ?: 'Label Preview' }}
                                </span>
                            </div>
                        </div>
