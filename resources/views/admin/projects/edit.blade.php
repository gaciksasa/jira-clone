                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.projects.update', $project) }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <small class="form-text text-muted">Project lead will be added automatically.</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0">Once deleted, it cannot be recovered. All tasks, sprints, and data associated with this project will be permanently removed.</p>
                        </div>
                        <div class="col-md-4 text-end">
                            <form method="POST" action="{{ route('admin.projects.destroy', $project) }}" onsubmit="return confirm('Are you sure you want to delete this project? This action cannot be undone and will remove all associated data including tasks, sprints, and comments.');">
                                @csrf
                                @method('DELETE')
